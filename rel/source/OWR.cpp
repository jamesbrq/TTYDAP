...
namespace mod::owr
{
    ...
    void OWR::Init()
    {
        ...
        g_seqSetSeq_trampoline = patch::hookFunction(ttyd::seqdrv::seqSetSeq,
                                                     ...
                                                     {
                                                         // Check if map is equal to 1 so we dont call a strcmp with an invalid
                                                         // pointer
        ...
        g_msgSearch_trampoline =
            patch::hookFunction(ttyd::msgdrv::msgSearch,
                                [](const char *msgKey)
                                {
        ...
        g_pouchRemoveItem_trampoline = patch::hookFunction(
            ttyd::mario_pouch::pouchRemoveItem,
            [](int32_t item_data)
            {
        ...
        g_partySetForceMove_trampoline =
            patch::hookFunction(ttyd::party::partySetForceMove,
        ...
        g_evt_mario_set_pose_trampoline = patch::hookFunction(
            ttyd::evt_mario::evt_mario_set_pose,
