...
void ShrinkAllocation(int32_t heap_id, OSModuleInfo *rel, int32_t new_size)
{
    ...
    gc::os::ChunkInfo *first_chunk = reinterpret_cast<gc::os::ChunkInfo *>(
    ...
    gc::os::ChunkInfo *second_chunk = reinterpret_cast<gc::os::ChunkInfo *>(
    ...
    gc::os::HeapInfo *heap_info = &gc::os::OSAlloc_HeapArray[heap_id];
    heap_info->firstFree = gc::os::DLInsert(heap_info->firstFree, second_chunk);
}
...
void MakeRelFixed(int32_t heap_id, OSModuleInfo *rel)
{
    ...
    constexpr int32_t kImpTableSectionSize = sizeof(OSModuleImpSection);
    ...
    const OSModuleImpSection *impTable = 
        reinterpret_cast<OSModuleImpSection *>(rel->impOffset);
