...
extern int32_t mri_fabio_init[];
extern int32_t mri_fabio_talk[];
extern int32_t mri_first_time_w_bero_00[];
extern int32_t mri_out_dokan_1[];
extern int32_t mri_first_bigtree[];
extern int32_t mri_open_bigtree[];
extern int32_t mri_mario_see_you[];
...
extern int32_t mri_elder_talk[];
extern int32_t mri_elder_talk_sub;
extern int32_t mri_puni_1_init[];
extern int32_t mri_puni_1_talk[];
extern int32_t mri_puni_2_init[];
extern int32_t mri_puni_2_talk[];
extern int32_t mri_sister_init_01[];
extern int32_t mri_sister_talk[];
extern int32_t mri_bigtree_firstbattle[];
extern int32_t mri_meet_rival[];
extern int32_t mri_rival_nakama[];
extern int32_t mri_boss_battle[];
extern int32_t mri_boss_battle_win[];
extern int32_t mri_evt_ueki_01[];
extern int32_t mri_evt_ueki_02[];
extern int32_t mri_evt_ueki_03[];
extern int32_t mri_evt_ueki_08[];
extern int32_t mri_01_koopa_first_evt[];
extern int32_t mri_01_koopa_second_evt[];
extern int32_t mri_01_init_evt[];
extern int32_t mri_dokan_event[];
extern int32_t mri_02_init_evt[];
extern int32_t mri_elder_rescue[];
extern int32_t mri_elder_init_03[];
extern int32_t mri_sister_init_03[];
extern int32_t mri_sister_regl[];
extern int32_t mri_puni_3_init[];
...
extern int32_t mri_chuchurina_sogu[];
extern int32_t mri_black_shadow[];
extern int32_t mri_04_init_evt[];
extern int32_t mri_puni_4_init[];
extern int32_t mri_puni_4_talk[];
extern int32_t mri_puni_5_init[];
extern int32_t mri_puni_5_talk[];
extern int32_t mri_05_init_evt[];
extern int32_t mri_rival_init_06[];
extern int32_t mri_rival_talk[];
extern int32_t mri_puni_6_init[];
extern int32_t mri_puni_6_talk[];
extern int32_t mri_puni_7_init[];
extern int32_t mri_puni_7_talk[];
extern int32_t mri_puni_8_init[];
extern int32_t mri_puni_8_talk[];
extern int32_t mri_puni_9_init[];
extern int32_t mri_puni_9_talk[];
extern int32_t mri_puni_10_init[];
extern int32_t mri_puni_10_talk[];
extern int32_t mri_puni_11_init[];
extern int32_t mri_puni_11_talk[];
extern int32_t mri_apper_toge[];
extern int32_t mri_06_init_evt[];
extern int32_t mri_chibitoge_init_07[];
extern int32_t mri_puniinfo_talk[];
extern int32_t mri_07_init_evt[];
extern int32_t mri_toge_1_init[];
extern int32_t mri_toge_1_talk[];
extern int32_t mri_toge_2_init[];
extern int32_t mri_toge_2_talk[];
extern int32_t mri_toge_3_init[];
extern int32_t mri_toge_3_talk[];
extern int32_t mri_toge_4_init[];
extern int32_t mri_toge_4_talk[];
extern int32_t mri_toge_5_init[];
extern int32_t mri_toge_5_talk[];
extern int32_t mri_toge_6_init[];
extern int32_t mri_toge_6_talk[];
extern int32_t mri_08_init_evt[];
extern int32_t mri_wall_roll[];
extern int32_t mri_slot00_event[];
extern int32_t mri_slot01_event[];
extern int32_t mri_slot02_event[];
extern int32_t mri_slot03_event[];
extern int32_t mri_slot_event[];
extern int32_t mri_get_blue_jail_key[];
extern int32_t mri_09_init_evt[];
extern int32_t mri_item_evt[];
extern int32_t mri_10_init_evt[];
extern int32_t mri_toge_7_init[];
extern int32_t mri_toge_7_talk[];
extern int32_t mri_toge_8_init[];
extern int32_t mri_toge_8_talk[];
extern int32_t mri_toge_9_init[];
extern int32_t mri_toge_9_talk[];
extern int32_t mri_toge_10_init[];
extern int32_t mri_toge_10_talk[];
extern int32_t mri_toge_11_init[];
extern int32_t mri_toge_11_talk[];
...
extern int32_t mri_puni_disp_info[];
extern int32_t mri_puni_init[];
extern int32_t mri_trap_event[];
extern int32_t mri_breakyuka_main[];
extern int32_t mri_switch_event[];
...
EVT_BEGIN(guide_talk_evt)
	IF_EQUAL(GSW(1702), 3)
		RUN_EVT(&mri_seal_bigtree)
		RETURN()
	END_IF()
	IF_EQUAL(GSW(1702), 4)
		RUN_EVT(&mri_seal_bigtree2)
		RETURN()
	END_IF()
	IF_EQUAL(GSW(1713), 1)
	...
	IF_LARGE_EQUAL(GSW(1713), 5)
		IF_SMALL_EQUAL(GSW(1713), 17)
			IF_EQUAL(GSWF(2829), 0)
				...
				RETURN()
			ELSE()
				RUN_CHILD_EVT(&mri_elder_talk_sub)
				RETURN()
			END_IF()
		END_IF()
	END_IF()
...
EVT_BEGIN(puniinfo_talk_evt)
	...
	IF_SMALL(GSW(1708), 17)
		SWITCH(LSW(714))
			CASE_EQUAL(0)
				USER_FUNC(evt_msg::evt_msg_print, 0, PTR("stg2_mri_f00_02_01"), 0, PTR("me"))
				SET(LSW(714), 1)
				RETURN()
			CASE_END()
			CASE_EQUAL(1)
				USER_FUNC(evt_msg::evt_msg_print, 0, PTR("stg2_mri_f00_02_02"), 0, PTR("me"))
				SET(LSW(714), 2)
				RETURN()
			CASE_END()
			CASE_EQUAL(2)
				USER_FUNC(evt_msg::evt_msg_print, 0, PTR("stg2_mri_f00_02_03"), 0, PTR("me"))
				SET(LSW(714), 0)
				RETURN()
			CASE_END()
		END_SWITCH()
	...
	SWITCH(LSW(714))
		CASE_EQUAL(0)
			USER_FUNC(evt_msg::evt_msg_print, 0, PTR("stg2_mri_f00_02_04"), 0, PTR("me"))
			SET(LSW(714), 1)
		CASE_END()
		CASE_EQUAL(1)
			USER_FUNC(evt_msg::evt_msg_print, 0, PTR("stg2_mri_f00_02_05"), 0, PTR("me"))
			SET(LSW(714), 2)
		CASE_END()
		CASE_EQUAL(2)
			USER_FUNC(evt_msg::evt_msg_print, 0, PTR("stg2_mri_f00_02_06"), 0, PTR("me"))
			SET(LSW(714), 0)
		CASE_END()
	END_SWITCH()
	RETURN()
...
EVT_BEGIN(puniinfo_talk_hook)
	RUN_CHILD_EVT(puniinfo_talk_evt)
	RETURN()
EVT_END()
...
EVT_BEGIN(mri_09_init_evt_evt)
	IF_EQUAL(GSWF(6024), 0)
		...
		RUN_EVT(&mri_slot_event)
		USER_FUNC(evt_mobj::evt_mobj_switch_red, 1, PTR("slot00"), -80, 0, 135, PTR(&mri_slot00_event), 0)
		USER_FUNC(evt_mobj::evt_mobj_switch_red, 1, PTR("slot01"), -30, 0, 135, PTR(&mri_slot01_event), 0)
		USER_FUNC(evt_mobj::evt_mobj_switch_red, 1, PTR("slot02"), 30, 0, 135, PTR(&mri_slot02_event), 0)
		USER_FUNC(evt_mobj::evt_mobj_switch_red, 1, PTR("slot03"), 80, 0, 135, PTR(&mri_slot03_event), 0)
...
namespace mod
{
    void main()
    {
        ...
        mri_seal_bigtree[203] = GSW(1702);
        mri_seal_bigtree[204] = 4;

        mri_seal_bigtree2[122] = GSW(1702);
        mri_seal_bigtree2[123] = 5;
        ...
        mri_fabio_init[1] = GSW(1708);
        mri_fabio_init[2] = 16;

        mri_fabio_talk[1] = GSW(1708);
        mri_fabio_talk[3] = 18;

        mri_first_time_w_bero_00[1] = GSW(1702);
        mri_first_time_w_bero_00[2] = 2;

        mri_out_dokan_1[1] = GSW(1713);
        mri_out_dokan_1[2] = 11;

        mri_first_bigtree[92] = GSW(1702);
        mri_first_bigtree[93] = 3;

        mri_open_bigtree[431] = GSW(1713);
        mri_open_bigtree[432] = 1;

        mri_mario_see_you[198] = GSW(1713);
        mri_mario_see_you[199] = 17;
        ...
        patch::writePatch(&mri_puni_2_init[0], puni_2_init_hook, sizeof(puni_2_init_hook));

        mri_puni_2_talk[1] = GSW(1708);
        mri_puni_2_talk[3] = 18;

        patch::writePatch(&mri_sister_init_01[0], mri_sister_init_01_hook, sizeof(mri_sister_init_01_hook));

        mri_sister_talk[17] = GSW(1708);
        mri_sister_talk[19] = 18;
        mri_sister_talk[198] = GSWF(6103);

        mri_bigtree_firstbattle[641] = GSW(1713);
        mri_bigtree_firstbattle[642] = 2;
        ...
        mri_boss_battle_win[1448] = GSW(1713);
        mri_boss_battle_win[1449] = 11;

        mri_evt_ueki_01[1] = GSW(1703);
        mri_evt_ueki_01[2] = 26;

        mri_evt_ueki_02[1] = GSW(1703);
        mri_evt_ueki_02[2] = 26;

        mri_evt_ueki_03[1] = GSW(1703);
        mri_evt_ueki_03[2] = 26;

        mri_evt_ueki_08[1] = GSW(1703);
        mri_evt_ueki_08[2] = 26;
        ...
        mri_dokan_event[109] = GSWF(6018);
        mri_dokan_event[110] = 1;
        ...
        mri_sister_regl[1] = GSW(1713);
        mri_sister_regl[2] = 4;
        mri_sister_regl[6] = GSWF(6021);
        mri_sister_regl[7] = 1;

        mri_puni_3_init[1] = GSW(1713);
        mri_puni_3_init[3] = 17;

        mri_puni_3_talk[1] = GSW(1708);
        mri_puni_3_talk[3] = 18;

        mri_bero_custom_00[4] = GSW(1713);
        mri_bero_custom_00[5] = 4;
        ...
        mri_chuchurina_sogu[802] = GSWF(6022);
        mri_chuchurina_sogu[803] = 1;

        mri_black_shadow[333] = GSW(1713);
        mri_black_shadow[334] = 4;
        ...
        mri_puni_4_init[1] = GSW(1713);
        mri_puni_4_init[3] = 17;

        mri_puni_4_talk[1] = GSW(1708);
        mri_puni_4_talk[3] = 18;

        mri_puni_5_init[1] = GSW(1713);
        mri_puni_5_init[3] = 17;

        mri_puni_5_talk[1] = GSW(1708);
        mri_puni_5_talk[3] = 18;
        ...
        mri_rival_talk[1] = GSW(1708);
        mri_rival_talk[3] = 18;

        mri_puni_6_init[1] = GSW(1713);
        mri_puni_6_init[3] = 17;

        mri_puni_6_talk[1] = GSW(1708);
        mri_puni_6_talk[3] = 18;

        mri_puni_7_init[1] = GSW(1713);
        mri_puni_7_init[3] = 17;

        mri_puni_7_talk[1] = GSW(1708);
        mri_puni_7_talk[3] = 18;

        mri_puni_8_init[1] = GSW(1713);
        mri_puni_8_init[3] = 17;

        mri_puni_8_talk[1] = GSW(1708);
        mri_puni_8_talk[3] = 18;

        mri_puni_9_init[1] = GSW(1713);
        mri_puni_9_init[3] = 17;

        mri_puni_9_talk[1] = GSW(1708);
        mri_puni_9_talk[3] = 18;

        mri_puni_10_init[1] = GSW(1713);
        mri_puni_10_init[3] = 17;

        mri_puni_10_talk[1] = GSW(1708);
        mri_puni_10_talk[3] = 18;

        mri_puni_11_init[1] = GSW(1713);
        mri_puni_11_init[3] = 17;

        mri_puni_11_talk[1] = GSW(1708);
        mri_puni_11_talk[3] = 18;

        mri_apper_toge[242] = GSWF(6023);
        mri_apper_toge[243] = 1;
        ...
        patch::writePatch(&mri_puniinfo_talk[0], puniinfo_talk_hook, sizeof(puniinfo_talk_hook));

        mri_07_init_evt[66] = GSW(1713);
        mri_07_init_evt[68] = 8;
        mri_07_init_evt[69] = 9;

        mri_toge_1_init[1] = GSW(1713);
        mri_toge_1_init[3] = 17;

        mri_toge_1_talk[1] = GSW(1708);
        mri_toge_1_talk[3] = 18;

        mri_toge_2_init[1] = GSW(1713);
        mri_toge_2_init[3] = 17;

        mri_toge_2_talk[1] = GSW(1708);
        mri_toge_2_talk[3] = 18;

        mri_toge_3_init[1] = GSW(1713);
        mri_toge_3_init[3] = 17;

        mri_toge_3_talk[1] = GSW(1708);
        mri_toge_3_talk[3] = 18;

        mri_toge_4_init[1] = GSW(1713);
        mri_toge_4_init[3] = 17;

        mri_toge_4_talk[1] = GSW(1708);
        mri_toge_4_talk[3] = 18;

        mri_toge_5_init[1] = GSW(1713);
        mri_toge_5_init[3] = 17;

        mri_toge_5_talk[1] = GSW(1708);
        mri_toge_5_talk[3] = 18;

        mri_toge_6_init[1] = GSW(1713);
        mri_toge_6_init[3] = 17;

        mri_toge_6_talk[1] = GSW(1708);
        mri_toge_6_talk[3] = 18;

        mri_08_init_evt[71] = GSW(1713);
        mri_08_init_evt[73] = 8;
        mri_08_init_evt[74] = 9;

        mri_wall_roll[261] = GSWF(6024);
        mri_wall_roll[262] = 1;

        mri_slot00_event[1] = GSWF(6024);
        mri_slot00_event[2] = 1;

        mri_slot01_event[1] = GSWF(6024);
        mri_slot01_event[2] = 1;

        mri_slot02_event[1] = GSWF(6024);
        mri_slot02_event[2] = 1;

        mri_slot03_event[1] = GSWF(6024);
        mri_slot03_event[2] = 1;

        mri_get_blue_jail_key[115] = GSWF(6021);
        mri_get_blue_jail_key[116] = 1;
        mri_get_blue_jail_key[117] = EVT_HELPER_CMD(1, 4);
        mri_get_blue_jail_key[118] = EVT_HELPER_OP(&mri_get_blue_jail_key[138]);
        ...
        mri_toge_7_init[1] = GSW(1713);
        mri_toge_7_init[3] = 17;

        mri_toge_7_talk[1] = GSW(1708);
        mri_toge_7_talk[3] = 18;

        mri_toge_8_init[1] = GSW(1713);
        mri_toge_8_init[3] = 17;

        mri_toge_8_talk[1] = GSW(1708);
        mri_toge_8_talk[3] = 18;

        mri_toge_9_init[1] = GSW(1713);
        mri_toge_9_init[3] = 17;

        mri_toge_9_talk[1] = GSW(1708);
        mri_toge_9_talk[3] = 18;

        mri_toge_10_init[1] = GSW(1713);
        mri_toge_10_init[3] = 17;

        mri_toge_10_talk[1] = GSW(1708);
        mri_toge_10_talk[3] = 18;

        mri_toge_11_init[1] = GSW(1713);
        mri_toge_11_init[3] = 17;

        mri_toge_11_talk[1] = GSW(1708);
        mri_toge_11_talk[3] = 18;
        ...
        mri_punipuni_ball00_init[6] = GSW(1713);
        mri_punipuni_ball00_init[7] = 6;
        mri_punipuni_ball00_init[36] = GSW(1713);
        mri_punipuni_ball00_init[37] = 6;
        ...
        mri_dai3_kanbu[170] = GSW(1713);
        mri_dai3_kanbu[171] = 7;
        ...
        mri_dai3_battle[121] = GSW(1713);
        mri_dai3_battle[122] = 9;
        ...
        mri_breakyuka_main[121] = 0; // Unused
