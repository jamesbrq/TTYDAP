...
extern int32_t eki_evt_bridge2[];
extern int32_t eki_evt_origami_00[];
extern int32_t eki_evt_meet_moamoa[];
extern int32_t eki_evt_moamoa_escape[];
extern int32_t eki_evt_elv_down[];
extern int32_t eki_evt_elv_up[];
extern int32_t eki_evt_elv[];
extern int32_t eki_item_tbl[];
extern int32_t eki_00_init_evt[];
extern int32_t eki_evt_origami_01[];
extern int32_t eki_evt_lock[];
extern int32_t eki_01_init_evt[];
extern int32_t eki_evt_key_02[];
extern int32_t eki_02_init_evt[];
extern int32_t eki_evt_poster[];
extern int32_t eki_evt_chk[];
extern int32_t eki_evt_boots[];
extern int32_t eki_evt_elvkey[];
extern int32_t eki_05_init_evt[];
extern int32_t eki_evt_box_open[];
extern int32_t eki_evt_sw_complete[];
...
EVT_BEGIN(evt_elv_evt)
	IF_SMALL(GSW(1720), 4)
		...
		IF_SMALL_EQUAL(LW(0), 0)
			...
			RETURN()
		END_IF()
		USER_FUNC(evt_window::evt_win_item_select, 0, PTR(&eki_item_tbl), LW(1), 0)
		IF_EQUAL(LW(1), -1)
			USER_FUNC(evt_mario::evt_mario_key_onoff, 1)
			SET(LW(0), 0)
			RETURN()
...
namespace mod
{
    void main()
    {
        eki_evt_bridge2[111] = GSW(1720);
        eki_evt_bridge2[112] = 8;
        ...
        eki_evt_elv_down[230] = GSW(1720);
        eki_evt_elv_down[231] = 6;
        eki_evt_elv_down[305] = GSW(1720);
        eki_evt_elv_down[306] = 6;
        eki_evt_elv_down[339] = GSW(1720);
        eki_evt_elv_down[341] = 6;
        eki_evt_elv_down[343] = 6;
        eki_evt_elv_down[362] = GSW(1720);
        eki_evt_elv_down[363] = 7;
        eki_evt_elv_down[398] = GSW(1720);
        eki_evt_elv_down[399] = 7;
        eki_evt_elv_down[532] = GSW(1720);
        eki_evt_elv_down[533] = 5;
        eki_evt_elv_down[538] = GSW(1720);
        eki_evt_elv_down[539] = 5;

        eki_evt_elv_up[116] = GSW(1720);
        eki_evt_elv_up[117] = 6;
        eki_evt_elv_up[191] = GSW(1720);
        eki_evt_elv_up[192] = 6;
        eki_evt_elv_up[325] = GSW(1720);
        eki_evt_elv_up[326] = 7;
        eki_evt_elv_up[329] = GSW(1720);
        eki_evt_elv_up[330] = 7;
        eki_evt_elv_up[381] = GSW(1720);
        eki_evt_elv_up[382] = 6;

        patch::writePatch(&eki_evt_elv[0], evt_elv_hook, sizeof(evt_elv_hook));
        eki_evt_elv[25] = GSW(1720);
        eki_evt_elv[26] = 4;
        ...
        eki_evt_chk[66] = GSWF(6061);
        eki_evt_chk[67] = 1;
        eki_evt_chk[69] = GSWF(6061);
        eki_evt_chk[70] = 1;

        eki_evt_boots[35] = GSWF(6064);
        eki_evt_boots[36] = 1;

        eki_evt_elvkey[1] = GSWF(6065);
        eki_evt_elvkey[2] = 1;
        ...
        eki_evt_box_open[1] = GSW(1722);
        eki_evt_box_open[2] = 1;
        eki_evt_box_open[108] = GSW(1722);
        eki_evt_box_open[109] = 1;

        eki_evt_sw_complete[265] = GSW(1722);
        eki_evt_sw_complete[266] = 2;
