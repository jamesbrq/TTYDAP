#ifndef TTYD_NPCDRV_H
#define TTYD_NPCDRV_H
...
extern "C"
{
    ...
    void npcSetColor(const char *name, const uint8_t *color[4]);
    ...
    uint32_t dbGetDefData(const DatabaseDefinition *definitions, const char *key);
