...
namespace ttyd::evt_npc
{
    ...
    extern "C"
    {
        ...
        // evt_npc_glide_position(char *name, float x, float y, float z, int timeMs, float unk0, float unk1, int
        // wInterpolationMode)
        ...
        // evt_npc_sound_data_set(char *name, int moveLeftSfxId, int moveRightSfxId, int unkSfxId, int jumpSfxId, int
        // landingSfxId)
