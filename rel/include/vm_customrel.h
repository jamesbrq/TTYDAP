...
bool LoadCustomRelVM(const char *relName = "custom", uint32_t cacheBytes = 0x10000); // 16 pages: 2 pinned headers + 14 free; watch FAULTCNT (0x80003B58)
...
bool LoadBothCustomRelsVM(const char *nameA = "custom", const char *nameB = "custom2", uint32_t cacheBytes = 0x10000);
